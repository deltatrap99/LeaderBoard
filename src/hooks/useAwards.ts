...
const DEFAULT_AWARDS: Award[] = [
  ...
  },
  {
    ...
    tiers: [
      { label: 'Top 1', condition: '>= 45', condition2: '>= 200 triệu đồng', quantity: '01', prizeValue: '1,500,000', extraCondition: '01' },
      { label: 'Top 2', condition: '>= 30', condition2: '>= 200 triệu đồng', quantity: '01', prizeValue: '1,000,000', extraCondition: '01' },
      { label: 'Top 3', condition: '>= 15', condition2: '>= 200 triệu đồng', quantity: '01', prizeValue: '800,000', extraCondition: '01' },
      { label: '⭐ EGC', condition: '>= 15', condition2: '>= 150 triệu đồng', quantity: '30', prizeValue: '500,000', extraCondition: '30' },
    ],
