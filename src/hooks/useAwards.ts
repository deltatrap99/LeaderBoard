...
const DEFAULT_AWARDS: Award[] = [
  // ============================================================
  // I. Chương trình Thưởng tháng 06
  // ============================================================
  {
    id: 'dai-su-moi-t06',
    title: 'Thưởng Đại sứ mới',
    period: 'Tháng 06 Năm 2026',
    category: 'month',
    mechanism: 'Thưởng Đại sứ mới lần đầu phát sinh doanh số, ghi nhận nỗ lực triển khai bán hàng trong giai đoạn đầu tham gia cộng đồng và đạt khởi đầu tích cực với doanh số tổng tháng từ 10 triệu trở lên.',
  ...
  },
  {
    ...
    tiers: [
      { label: 'Top 1', condition: '>= 5', condition2: '>= 30,000,000đ', quantity: '1', prizeValue: '500,000', cellValues: ['Top 1', '>= 5', '>= 30.000.000 ₫', '1', '500.000 ₫'] },
    ],
    order: 3,
  },
  {
    ...
    tiers: [
      { label: 'Cấp Nhóm', condition: '>= 100%', condition2: '>= 5', quantity: '1', prizeValue: '500,000', cellValues: ['Cấp Nhóm', '>= 100%', '>= 5', '1', '500.000 ₫'] },
      { label: 'Cấp Phòng', condition: '>= 100%', condition2: '>= 10', quantity: '1', prizeValue: '800,000', cellValues: ['Cấp Phòng', '>= 100%', '>= 10', '1', '800.000 ₫'] },
      { label: 'Cấp Khu vực', condition: '>= 100%', condition2: '>= 15', quantity: '1', prizeValue: '1,000,000', cellValues: ['Cấp Khu vực', '>= 100%', '>= 15', '1', '1.000.000 ₫'] },
    ],
    order: 4,
  },
  ...
  },
  {
    ...
    tiers: [
      { label: 'Cấp Nhóm - Trưởng Nhóm', condition: '>= 100%', condition2: '>= 10', quantity: '1', prizeValue: '500,000', cellValues: ['Cấp Nhóm - Trưởng Nhóm', '>= 100%', '>= 10', '1', '500.000 đ', 'Thông qua đề xuất/ bình chọn/ xét duyệt dựa trên các yếu tố biểu dương khác'] },
      { label: 'Cấp Nhóm - Trưởng Nhóm Cấp Cao', condition: '>= 100%', condition2: '>= 10', quantity: '1', prizeValue: '500,000', cellValues: ['Cấp Nhóm - Trưởng Nhóm Cấp Cao', '>= 100%', '>= 10', '1', '500.000 đ', 'Thông qua đề xuất/ bình chọn/ xét duyệt dựa trên các yếu tố biểu dương khác'] },
      { label: 'Cấp Phòng - Trưởng Phòng', condition: '>= 100%', condition2: '>= 20', quantity: '1', prizeValue: '1,000,000', cellValues: ['Cấp Phòng - Trưởng Phòng', '>= 100%', '>= 20', '1', '1.000.000 đ', 'Thông qua đề xuất/ bình chọn/ xét duyệt dựa trên các yếu tố biểu dương khác'] },
      { label: 'Cấp Phòng - Trưởng Phòng Cấp Cao', condition: '>= 100%', condition2: '>= 20', quantity: '1', prizeValue: '1,000,000', cellValues: ['Cấp Phòng - Trưởng Phòng Cấp Cao', '>= 100%', '>= 20', '1', '1.000.000 đ', 'Thông qua đề xuất/ bình chọn/ xét duyệt dựa trên các yếu tố biểu dương khác'] },
      { label: 'Cấp Khu vực - Giám Đốc Khu Vực', condition: '>= 100%', condition2: '>= 30', quantity: '1', prizeValue: '2,000,000', cellValues: ['Cấp Khu vực - Giám Đốc Khu Vực', '>= 100%', '>= 30', '1', '2.000.000 đ', 'Thông qua đề xuất/ bình chọn/ xét duyệt dựa trên các yếu tố biểu dương khác'] },
      { label: 'Cấp Khu vực - Giám Đốc Khu Vực Cấp Cao', condition: '>= 100%', condition2: '>= 30', quantity: '1', prizeValue: '2,000,000', cellValues: ['Cấp Khu vực - Giám Đốc Khu Vực Cấp Cao', '>= 100%', '>= 30', '1', '2.000.000 đ', 'Thông qua đề xuất/ bình chọn/ xét duyệt dựa trên các yếu tố biểu dương khác'] },
    ],
    order: 9,
  },
