    ...
    <>
      ...
      >
        {[
          ...
          { icon: <TrendingUp size={18} />, value: '30p', label: settings.statsLabels?.update || 'Cập nhật' },
        ].map((stat, i) => (
    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div className={`flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border text-xs sm:text-sm font-medium ${
          ...
          <span>Dữ liệu được cập nhật tự động 30 phút/ lần. Vui lòng tải lại trang (F5) để xem kết quả mới nhất!</span>
        </div>
